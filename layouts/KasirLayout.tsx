      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <header className={`h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-6 no-print shrink-0 relative ${isNotificationOpen ? 'z-[80]' : 'z-[10]'}`}>
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-2 px-2.5 py-1.5 bg-amber-50 rounded-lg border border-amber-100 max-w-[140px] xs:max-w-[200px] sm:max-w-none">
          ...
          <div className="flex items-center gap-1.5 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 pl-1.5 sm:pl-4 border-l border-amber-100">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-[8px] sm:text-[10px] text-amber-600 font-black tracking-widest uppercase">{activeAccount.name}</p>
              </div>
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-amber-100 text-amber-700 rounded-lg sm:rounded-xl flex items-center justify-center font-black text-xs sm:text-sm border-2 border-amber-50 shrink-0">KS</div>
            </div>
          </div>
        </header>
